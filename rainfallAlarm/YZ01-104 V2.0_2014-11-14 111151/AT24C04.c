...
/**************************************************************
函数名称：unsigned char WriteInt(char dataaddr,unsigned int num)
...
char WriteUInt16(unsigned int num,char dataaddr,char page)
{
  ...
  if(Write_1Byte(u16b.bit16.nHigh,dataaddr,page)==0)   //写入高8bit
    return 0;
    
  if(Write_1Byte(u16b.bit16.nLow,dataaddr+1,page)==0) //写入低8bit
    return 0;
...
/**************************************************************
函数名称：unsigned int ReadInt(char addr)
...
unsigned int ReadUInt16(char addr,char page)
{
  ...
  Read_NByte_Randomaddress(data8,2,addr,page);//连续读出2byte数据
...
/**************************************************************
函数名称：unsigned char WriteSInt32(char dataaddr,long num)
...
signed long ReadSInt32(char addr,char page)
{
  ...
  Read_NByte_Randomaddress(data8,4,addr,page);//连续读出4byte数据
