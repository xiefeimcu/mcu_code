...
//extern const menu_t mainMenu[4];
//extern const menu_t basicMenu[3];



//const menu_t mainMenu[4]={
//	{"基本设置",NULL,NULL,basicMenu,MENU_IVACTIVE,},
//
//	{"采样设置",NULL,NULL,NULL,MENU_IVACTIVE,},
//
//	{"发报设置",NULL,NULL,NULL,MENU_IVACTIVE,},
//
//	{"重置设置",NULL,NULL,NULL,MENU_IVACTIVE,}
//};
//
//
//
//const uint8_t basicMenu[3]={
//	{"时间设置",NULL,basicMenu,mainMenu,MENU_IVACTIVE,},
//
//	{"休眠时间",NULL,mainMenu,NULL,MENU_IVACTIVE,},
//
//	{"背光时间",NULL,mainMenu,NULL,MENU_IVACTIVE,}
//};
